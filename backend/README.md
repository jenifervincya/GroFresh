...
## Repo Structure
Other pieces of the platform (mobile app, AI pricing engine, hardware
integration) live in their own repos/folders as the team adds them.

## Getting Started

Backend setup, environment variables, database schema, and the full endpoint
list are documented in [`src/README.md`](./src/README.md). If you're working
on the app, pricing model, or hardware integration, start there for how to
run the backend locally against your own work.

## Status

Core backend (auth, batches, KYC, delivery/escrow, notifications, chat) is
built and tested end-to-end. Open items are tracked in `src/README.md`.
